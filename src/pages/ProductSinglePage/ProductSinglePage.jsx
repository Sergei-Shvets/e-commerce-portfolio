                            ...
                            <div className="product-details font-manrope">
                                ...
                                <div className="price">
                                    <div className="flex align-center">
                                        ...
                                        <span className="fs-14 mx-2 text-dark">Including all taxes</span>
                                    </div>
                                ...
                                <div className="btns">
                                    <button type="button" className="add-to-cart-btn btn">
                                        ...
                                        <span className="btn-next mx-2" onClick={() => addToCartHadler(product)}>
                                            add to cart
                                        </span>
                                    </button>
